    ...
    >
      ...
      >
        ...
        <Row :gutter="16">
          <Col span="12">
            <FormItem label="纸飞机机器人令牌">
              <Input
                v-model="formModel.fields.telegramBotToken"
                placeholder="请输入纸飞机机器人令牌"
              />
            </FormItem>
          </Col>
          <Col span="12">
            <FormItem label="纸飞机广播群ID">
              <Input
                v-model="formModel.fields.telegramChatId"
                placeholder="请输入纸飞机广播群ID"
              />
            </FormItem>
          </Col>
        </Row>
        ...
        <FormItem label="用户头像" label-position="top">
          <img
            :src="formModel.fields.avatar"
            alt
            style="width: 58px; height: 58px; display: inline-block"
          />
    ...
    handleUpload(file) {
      ...
      upload(formData).then((res) => {
        if (res.data.code == 200) {
          this.formModel.fields.avatar = res.data.data.hostUrl
        } else {
