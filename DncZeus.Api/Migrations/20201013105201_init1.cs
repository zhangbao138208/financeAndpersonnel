        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    Application = table.Column<string>(type: "nvarchar(255)", nullable: true),
                    Levels = table.Column<string>(type: "nvarchar(255)", nullable: true),
                    Operatingtime = table.Column<string>(type: "nvarchar(255)", nullable: true),
                    Operatingaddress = table.Column<string>(type: "nvarchar(255)", nullable: true),
                    Logger = table.Column<string>(type: "nvarchar(255)", nullable: true),
                    Callsite = table.Column<string>(type: "nvarchar(255)", nullable: true),
                    Requesturl = table.Column<string>(type: "nvarchar(255)", nullable: true),
